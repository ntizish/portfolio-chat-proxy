import { GEN_AI_OPERATION_NAME_VALUE_CHAT, GEN_AI_OPERATION_NAME_VALUE_GENERATE_CONTENT, GEN_AI_OPERATION_NAME_VALUE_TEXT_COMPLETION } from '@opentelemetry/semantic-conventions/incubating';
...
traceContent = true) {
    ...
    if (traceContent) {
        ...
        else if (type === GEN_AI_OPERATION_NAME_VALUE_TEXT_COMPLETION &&
