...
class CohereInstrumentation extends instrumentation.InstrumentationBase {
    ...
    _startSpan({ params, type, }) {
        ...
        const attributes = {
            [incubating.ATTR_GEN_AI_SYSTEM]: "Cohere",
        ...
        try {
            ...
            if (!("query" in params)) {
                attributes[incubating.ATTR_GEN_AI_REQUEST_TOP_P] = params.p;
                ...
                attributes[incubating.ATTR_GEN_AI_REQUEST_MAX_TOKENS] = params.maxTokens;
            }
            else {
            ...
            if (this._shouldSendPrompts()) {
                if (type === "completion" && "prompt" in params) {
                    ...
                    attributes[`${incubating.ATTR_GEN_AI_PROMPT}.0.user`] = params.prompt;
                }
                    ...
                    (_b = params.chatHistory) === null || _b === void 0 ? void 0 : _b.forEach((msg, index) => {
                        ...
                        if (msg.role !== "TOOL") {
                            attributes[`${incubating.ATTR_GEN_AI_PROMPT}.${index}.content`] =
                                msg.message;
                        }
                    });
                    attributes[`${incubating.ATTR_GEN_AI_PROMPT}.${(_d = (_c = params.chatHistory) === null || _c === void 0 ? void 0 : _c.length) !== null && _d !== void 0 ? _d : 0}.role`] = "user";
                    attributes[`${incubating.ATTR_GEN_AI_PROMPT}.${(_f = (_e = params.chatHistory) === null || _e === void 0 ? void 0 : _e.length) !== null && _f !== void 0 ? _f : 0}.user`] = params.message;
                }
                else if (type === "rerank" && "query" in params) {
                    attributes[`${incubating.ATTR_GEN_AI_PROMPT}.0.role`] = "user";
                    attributes[`${incubating.ATTR_GEN_AI_PROMPT}.0.user`] = params.query;
            ...
            if ("meta" in result) {
                ...
                if (this._shouldSendPrompts()) {
                    result.results.forEach((each, idx) => {
                        var _a;
                        span.setAttribute(`${incubating.ATTR_GEN_AI_COMPLETION}.${idx}.relevanceScore`, each.relevanceScore);
                        if (each.document && ((_a = each.document) === null || _a === void 0 ? void 0 : _a.text)) {
                            span.setAttribute(`${incubating.ATTR_GEN_AI_COMPLETION}.${idx}.content`, each.document.text);
                        }
                    });
                }
                else {
                    result.results.forEach((each, idx) => {
                        span.setAttribute(`${incubating.ATTR_GEN_AI_COMPLETION}.${idx}.content`, each.index);
                        span.setAttribute(`${incubating.ATTR_GEN_AI_COMPLETION}.${idx}.relevanceScore`, each.relevanceScore);
                    });
                }
            }
        ...
        try {
            if ("token_count" in result && typeof result.token_count === "object") {
                if (result.token_count &&
                    ...
                    span.setAttribute(incubating.ATTR_GEN_AI_USAGE_PROMPT_TOKENS, (_a = result.token_count) === null || _a === void 0 ? void 0 : _a.prompt_tokens);
                }
                if (result.token_count &&
                    "response_tokens" in result.token_count &&
                    typeof result.token_count.response_tokens === "number") {
                    span.setAttribute(incubating.ATTR_GEN_AI_USAGE_COMPLETION_TOKENS, (_b = result.token_count) === null || _b === void 0 ? void 0 : _b.response_tokens);
                }
                if (result.token_count &&
            ...
            if (this._shouldSendPrompts()) {
                ...
                span.setAttribute(`${incubating.ATTR_GEN_AI_COMPLETION}.0.content`, result.text);
                if ((_d = result.searchQueries) === null || _d === void 0 ? void 0 : _d[0].text) {
                    span.setAttribute(`${incubating.ATTR_GEN_AI_COMPLETION}.0.searchQuery`, (_e = result.searchQueries) === null || _e === void 0 ? void 0 : _e[0].text);
                }
                if ((_f = result.searchResults) === null || _f === void 0 ? void 0 : _f.length) {
                    result.searchResults.forEach((searchResult, index) => {
                        if (searchResult.searchQuery) {
                            span.setAttribute(`${incubating.ATTR_GEN_AI_COMPLETION}.0.searchResult.${index}.text`, searchResult.searchQuery.text);
                        }
                        span.setAttribute(`${incubating.ATTR_GEN_AI_COMPLETION}.0.searchResult.${index}.connector`, searchResult.connector.id);
                    });
                }
            }
            if ("finishReason" in result && typeof result.finishReason === "string") {
                span.setAttribute(`${incubating.ATTR_GEN_AI_COMPLETION}.0.finish_reason`, result.finishReason);
            }
        }
        catch (e) {
            this._diag.debug(e);
        ...
        try {
            if (result && "meta" in result) {
                if (typeof ((_b = (_a = result.meta) === null || _a === void 0 ? void 0 : _a.billedUnits) === null || _b === void 0 ? void 0 : _b.inputTokens) === "number") {
                    span.setAttribute(incubating.ATTR_GEN_AI_USAGE_PROMPT_TOKENS, (_d = (_c = result.meta) === null || _c === void 0 ? void 0 : _c.billedUnits) === null || _d === void 0 ? void 0 : _d.inputTokens);
                }
                if (typeof ((_f = (_e = result.meta) === null || _e === void 0 ? void 0 : _e.billedUnits) === null || _f === void 0 ? void 0 : _f.outputTokens) === "number") {
                    span.setAttribute(incubating.ATTR_GEN_AI_USAGE_COMPLETION_TOKENS, (_h = (_g = result.meta) === null || _g === void 0 ? void 0 : _g.billedUnits) === null || _h === void 0 ? void 0 : _h.outputTokens);
                }
            ...
            if (this._shouldSendPrompts() && result.generations) {
                span.setAttribute(`${incubating.ATTR_GEN_AI_COMPLETION}.0.role`, "assistant");
                span.setAttribute(`${incubating.ATTR_GEN_AI_COMPLETION}.0.content`, result.generations[0].text);
            }
            if (result.generations &&
                "finish_reason" in result.generations[0] &&
                typeof result.generations[0].finish_reason === "string") {
                span.setAttribute(`${incubating.ATTR_GEN_AI_COMPLETION}.0.finish_reason`, result.generations[0].finish_reason);
            }
            if (result.generations &&
                "finishReason" in result.generations[0] &&
                typeof result.generations[0].finishReason === "string") {
                span.setAttribute(`${incubating.ATTR_GEN_AI_COMPLETION}.0.finish_reason`, result.generations[0].finishReason);
            }
        }
        catch (e) {
            this._diag.debug(e);
