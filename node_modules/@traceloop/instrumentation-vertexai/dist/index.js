 ...
 */
class AIPlatformInstrumentation extends instrumentation.InstrumentationBase {
    constructor(config = {}) {
    ...
    init() {
        const aiPlatformModule = new instrumentation.InstrumentationNodeModuleDefinition("@google-cloud/aiplatform", [">=3.10.0"], this.wrap.bind(this), this.unwrap.bind(this));
    ...
    _startSpan({ params, }) {
        ...
        const attributes = {
            [incubating.ATTR_GEN_AI_SYSTEM]: "Google",
        ...
        try {
            if (params !== undefined) {
                if (params.endpoint) {
                    ...
                    attributes[incubating.ATTR_GEN_AI_REQUEST_MODEL] = model;
                    attributes[incubating.ATTR_GEN_AI_RESPONSE_MODEL] = model;
                }
                if (params === null || params === void 0 ? void 0 : params.parameters) {
                    ...
                    if ((_f = (_e = params === null || params === void 0 ? void 0 : params.parameters.structValue) === null || _e === void 0 ? void 0 : _e.fields) === null || _f === void 0 ? void 0 : _f.temperature.numberValue) {
                        attributes[incubating.ATTR_GEN_AI_REQUEST_TEMPERATURE] =
                    ...
                    if ((_k = (_j = params === null || params === void 0 ? void 0 : params.parameters.structValue) === null || _j === void 0 ? void 0 : _j.fields) === null || _k === void 0 ? void 0 : _k.topP.numberValue) {
                        attributes[incubating.ATTR_GEN_AI_REQUEST_TOP_P] =
                    ...
                    if ((_p = (_o = params === null || params === void 0 ? void 0 : params.parameters.structValue) === null || _o === void 0 ? void 0 : _o.fields) === null || _p === void 0 ? void 0 : _p.topK.numberValue) {
                        attributes[aiSemanticConventions.SpanAttributes.LLM_TOP_K] =
                ...
                if (this._shouldSendPrompts() &&
                    ...
                    if (((_t = params.instances[0].structValue) === null || _t === void 0 ? void 0 : _t.fields) &&
                        ...
                        attributes[`${incubating.ATTR_GEN_AI_PROMPT}.0.role`] =
    ...
    _endSpan({ span, result, }) {
        ...
        try {
            if (result[0].model)
                span.setAttribute(incubating.ATTR_GEN_AI_RESPONSE_MODEL, result[0].model);
            if (result) {
                if (result[0].metadata) {
                    if (typeof ((_g = (_f = (_e = (_d = (_c = (_b = (_a = result[0].metadata) === null || _a === void 0 ? void 0 : _a.structValue) === null || _b === void 0 ? void 0 : _b.fields) === null || _c === void 0 ? void 0 : _c.tokenMetadata.structValue) === null || _d === void 0 ? void 0 : _d.fields) === null || _e === void 0 ? void 0 : _e.outputTokenCount.structValue) === null || _f === void 0 ? void 0 : _f.fields) === null || _g === void 0 ? void 0 : _g.totalTokens.numberValue) === "number")
                        span.setAttribute(incubating.ATTR_GEN_AI_USAGE_COMPLETION_TOKENS, (_p = (_o = (_m = (_l = (_k = (_j = (_h = result[0].metadata) === null || _h === void 0 ? void 0 : _h.structValue) === null || _j === void 0 ? void 0 : _j.fields) === null || _k === void 0 ? void 0 : _k.tokenMetadata.structValue) === null || _l === void 0 ? void 0 : _l.fields) === null || _m === void 0 ? void 0 : _m.outputTokenCount.structValue) === null || _o === void 0 ? void 0 : _o.fields) === null || _p === void 0 ? void 0 : _p.totalTokens.numberValue);
                    ...
                    if (typeof ((_10 = (_9 = (_8 = (_7 = (_6 = (_5 = (_4 = result[0].metadata) === null || _4 === void 0 ? void 0 : _4.structValue) === null || _5 === void 0 ? void 0 : _5.fields) === null || _6 === void 0 ? void 0 : _6.tokenMetadata.structValue) === null || _7 === void 0 ? void 0 : _7.fields) === null || _8 === void 0 ? void 0 : _8.inputTokenCount.structValue) === null || _9 === void 0 ? void 0 : _9.fields) === null || _10 === void 0 ? void 0 : _10.totalTokens.numberValue) === "number" &&
                        ...
                        span.setAttribute(aiSemanticConventions.SpanAttributes.LLM_USAGE_TOTAL_TOKENS, ((_24 = (_23 = (_22 = (_21 = (_20 = (_19 = (_18 = result[0].metadata) === null || _18 === void 0 ? void 0 : _18.structValue) === null || _19 === void 0 ? void 0 : _19.fields) === null || _20 === void 0 ? void 0 : _20.tokenMetadata.structValue) === null || _21 === void 0 ? void 0 : _21.fields) === null || _22 === void 0 ? void 0 : _22.inputTokenCount.structValue) === null || _23 === void 0 ? void 0 : _23.fields) === null || _24 === void 0 ? void 0 : _24.totalTokens.numberValue) +
                ...
                if (this._shouldSendPrompts()) {
                    (_32 = result[0].predictions) === null || _32 === void 0 ? void 0 : _32.forEach((prediction, index) => {
                        ...
                        if (((_a = prediction.structValue) === null || _a === void 0 ? void 0 : _a.fields) &&
                            ...
                            span.setAttribute(`${incubating.ATTR_GEN_AI_COMPLETION}.${index}.role`, "assistant");
                            span.setAttribute(`${incubating.ATTR_GEN_AI_COMPLETION}.${index}.content`, (_e = (_d = prediction.structValue) === null || _d === void 0 ? void 0 : _d.fields) === null || _e === void 0 ? void 0 : _e.content.stringValue);
                        }
                            ...
                            span.setAttribute(`${incubating.ATTR_GEN_AI_COMPLETION}.${index}.role`, "assistant");
                            span.setAttribute(`${incubating.ATTR_GEN_AI_COMPLETION}.${index}.content`, (_v = (_u = (_t = (_s = (_r = (_q = (_p = prediction.structValue) === null || _p === void 0 ? void 0 : _p.fields) === null || _q === void 0 ? void 0 : _q.candidates.listValue) === null || _r === void 0 ? void 0 : _r.values) === null || _s === void 0 ? void 0 : _s[0]) === null || _t === void 0 ? void 0 : _t.structValue) === null || _u === void 0 ? void 0 : _u.fields) === null || _v === void 0 ? void 0 : _v.content.stringValue);
                        }
                    });
                }
            }
...
class VertexAIInstrumentation extends instrumentation.InstrumentationBase {
    constructor(config = {}) {
        super("@traceloop/instrumentation-vertexai", version, config);
    }
    setConfig(config = {}) {
    ...
    init() {
        const vertexAIModule = new instrumentation.InstrumentationNodeModuleDefinition("@google-cloud/vertexai", [">=1.1.0"], this.wrap.bind(this), this.unwrap.bind(this));
    ...
    _startSpan({ instance, params, }) {
        ...
        try {
            attributes[incubating.ATTR_GEN_AI_REQUEST_MODEL] = instance["model"];
            attributes[incubating.ATTR_GEN_AI_RESPONSE_MODEL] = instance["model"];
            ...
            if (this._shouldSendPrompts() && "contents" in params) {
                ...
                if (instance["systemInstruction"]) {
                    attributes[`${incubating.ATTR_GEN_AI_PROMPT}.${i}.role`] = "system";
                    attributes[`${incubating.ATTR_GEN_AI_PROMPT}.${i}.content`] =
                        this._formatPartsData(instance["systemInstruction"].parts);
                    i++;
                }
                params.contents.forEach((content, j) => {
                    var _a;
                    attributes[`${incubating.ATTR_GEN_AI_PROMPT}.${i + j}.role`] =
                        (_a = content.role) !== null && _a !== void 0 ? _a : "user";
                    attributes[`${incubating.ATTR_GEN_AI_PROMPT}.${i + j}.content`] =
        ...
        return tslib.__awaiter(this, arguments, void 0, function* ({ span, result, }) {
            ...
            try {
                ...
                if (((_b = streamResponse.usageMetadata) === null || _b === void 0 ? void 0 : _b.totalTokenCount) !== undefined)
                    span.setAttribute(aiSemanticConventions.SpanAttributes.LLM_USAGE_TOTAL_TOKENS, streamResponse.usageMetadata.totalTokenCount);
                if ((_c = streamResponse.usageMetadata) === null || _c === void 0 ? void 0 : _c.candidatesTokenCount)
                    span.setAttribute(incubating.ATTR_GEN_AI_USAGE_COMPLETION_TOKENS, streamResponse.usageMetadata.candidatesTokenCount);
                if ((_d = streamResponse.usageMetadata) === null || _d === void 0 ? void 0 : _d.promptTokenCount)
                    span.setAttribute(incubating.ATTR_GEN_AI_USAGE_PROMPT_TOKENS, streamResponse.usageMetadata.promptTokenCount);
                if (this._shouldSendPrompts()) {
                    (_e = streamResponse.candidates) === null || _e === void 0 ? void 0 : _e.forEach((candidate, index) => {
                        var _a;
                        if (candidate.finishReason)
                            span.setAttribute(`${incubating.ATTR_GEN_AI_COMPLETION}.${index}.finish_reason`, candidate.finishReason);
                        if (candidate.content) {
                            span.setAttribute(`${incubating.ATTR_GEN_AI_COMPLETION}.${index}.role`, (_a = candidate.content.role) !== null && _a !== void 0 ? _a : "assistant");
                            span.setAttribute(`${incubating.ATTR_GEN_AI_COMPLETION}.${index}.content`, this._formatPartsData(candidate.content.parts));
                        }
                    });
                }
            }
...
exports.AIPlatformInstrumentation = AIPlatformInstrumentation;
exports.VertexAIInstrumentation = VertexAIInstrumentation;
