export declare const SpanAttributes: {
    GEN_AI_USAGE_CACHE_CREATION_INPUT_TOKENS: string;
    GEN_AI_USAGE_CACHE_READ_INPUT_TOKENS: string;
    GEN_AI_USAGE_REASONING_TOKENS: string;
    GEN_AI_REQUEST_THINKING_TYPE: string;
    GEN_AI_REQUEST_THINKING_BUDGET_TOKENS: string;
    LLM_REQUEST_TYPE: string;
    GEN_AI_USAGE_TOTAL_TOKENS: string;
