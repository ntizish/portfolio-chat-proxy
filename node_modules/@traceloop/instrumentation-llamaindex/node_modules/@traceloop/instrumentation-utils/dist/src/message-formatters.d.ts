 ...
 */
export declare function formatSystemInstructions(system: string | Array<{
    type: string;
    text?: string;
    [key: string]: any;
}>): string;
 ...
 */
export declare function formatInputMessages(messages: Array<{
    role: string;
 ...
 */
export declare function formatInputMessagesFromPrompt(prompt: string, traceContent?: boolean): string;
/**
 ...
 */
export declare function formatOutputMessage(content: Array<any> | string, stopReason: string | null, finishReasonMap: Record<string, string>, type: string, contentBlockMapper: (block: any) => object, traceContent?: boolean): string;
