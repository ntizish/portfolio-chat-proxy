...
import { mapOpenAIContentBlock, formatInputMessagesFromPrompt } from '@traceloop/instrumentation-utils';
import { GEN_AI_PROVIDER_NAME_VALUE_OPENAI, ATTR_GEN_AI_OPERATION_NAME, ATTR_GEN_AI_PROVIDER_NAME, ATTR_GEN_AI_USAGE_INPUT_TOKENS, ATTR_GEN_AI_OUTPUT_MESSAGES, ATTR_GEN_AI_INPUT_MESSAGES, ATTR_GEN_AI_REQUEST_MODEL, ATTR_GEN_AI_USAGE_OUTPUT_TOKENS, GEN_AI_OPERATION_NAME_VALUE_CHAT, GEN_AI_OPERATION_NAME_VALUE_TEXT_COMPLETION, ATTR_GEN_AI_REQUEST_MAX_TOKENS, ATTR_GEN_AI_REQUEST_TEMPERATURE, ATTR_GEN_AI_REQUEST_TOP_P, ATTR_GEN_AI_REQUEST_FREQUENCY_PENALTY, ATTR_GEN_AI_REQUEST_PRESENCE_PENALTY, ATTR_GEN_AI_TOOL_DEFINITIONS, ATTR_GEN_AI_RESPONSE_MODEL, ATTR_GEN_AI_RESPONSE_ID, ATTR_GEN_AI_RESPONSE_FINISH_REASONS, GEN_AI_PROVIDER_NAME_VALUE_AZURE_AI_OPENAI, GEN_AI_PROVIDER_NAME_VALUE_AWS_BEDROCK, GEN_AI_PROVIDER_NAME_VALUE_GCP_VERTEX_AI } from '@opentelemetry/semantic-conventions/incubating';
 ...
 * @returns Array with a single OTelOutputMessage
 */
function buildOpenAIResponsesOutputMessage(result) {
    var _a, _b;
    let finishReason = FinishReasons.STOP;
    if (result.status === "completed") {
        finishReason = FinishReasons.STOP;
    }
    else if (result.status === "incomplete") {
        const reason = (_a = result.incomplete_details) === null || _a === void 0 ? void 0 : _a.reason;
    ...
    return [
        {
            ...
            parts: [{ type: "text", content: (_b = result.output_text) !== null && _b !== void 0 ? _b : "" }],
        },
    ];
}
/**
...
const RESPONSES_TYPE = "responses";
function getResponsesClass(moduleExports) {
    return moduleExports.OpenAI
        .Responses;
}
class OpenAIInstrumentation extends InstrumentationBase {
    ...
    manuallyInstrument(module) {
        ...
        this._wrap(openaiModule.Chat.Completions.prototype, "create", this.patchOpenAI(GEN_AI_OPERATION_NAME_VALUE_CHAT));
        this._wrap(openaiModule.Completions.prototype, "create", this.patchOpenAI(GEN_AI_OPERATION_NAME_VALUE_TEXT_COMPLETION));
        if (openaiModule.Responses) {
            this._wrap(openaiModule.Responses.prototype, "create", this.patchOpenAI(RESPONSES_TYPE));
        }
    ...
    init() {
        const module = new InstrumentationNodeModuleDefinition("openai", [">=4 <7"], this.patch.bind(this), this.unpatch.bind(this));
        return module;
    }
    patch(moduleExports, moduleVersion) {
        ...
        if (moduleExports.OpenAIApi) {
            this._wrap(moduleExports.OpenAIApi.prototype, "createChatCompletion", this.patchOpenAI(GEN_AI_OPERATION_NAME_VALUE_CHAT, "v3"));
            this._wrap(moduleExports.OpenAIApi.prototype, "createCompletion", this.patchOpenAI(GEN_AI_OPERATION_NAME_VALUE_TEXT_COMPLETION, "v3"));
        }
        else {
            this._wrap(moduleExports.OpenAI.Chat.Completions.prototype, "create", this.patchOpenAI(GEN_AI_OPERATION_NAME_VALUE_CHAT));
            this._wrap(moduleExports.OpenAI.Completions.prototype, "create", this.patchOpenAI(GEN_AI_OPERATION_NAME_VALUE_TEXT_COMPLETION));
            const Responses = getResponsesClass(moduleExports);
            if (Responses) {
                this._wrap(Responses.prototype, "create", this.patchOpenAI(RESPONSES_TYPE));
            }
    ...
    patchOpenAI(type, version = "v4") {
        ...
        return (original) => {
            return function method(...args) {
                ...
                const isStream = (_a = args[0]) === null || _a === void 0 ? void 0 : _a.stream;
                if (type === RESPONSES_TYPE) {
                    ...
                    const wrappedPromise = plugin._wrapPromise(RESPONSES_TYPE, version, span, execPromise);
        ...
        try {
            ...
            if (this._shouldSendPrompts()) {
                if (type === GEN_AI_OPERATION_NAME_VALUE_CHAT) {
                    ...
                    attributes[ATTR_GEN_AI_INPUT_MESSAGES] =
                        formatInputMessagesFromPrompt(typeof params.prompt === "string"
                            ? params.prompt
    ...
    _startResponsesSpan(params, client) {
        var _a, _b;
        const { provider } = this._detectVendorFromURL(client);
        ...
        try {
            ...
            if (this._shouldSendPrompts()) {
                const text = typeof params.input === "string"
                    ? params.input
        ...
        return this.tracer.startSpan(`${GEN_AI_OPERATION_NAME_VALUE_CHAT} ${params === null || params === void 0 ? void 0 : params.model}`, {
            kind: SpanKind.CLIENT,
            attributes,
        });
    }
    ...
    _endSpan({ span, type, result, }) {
        ...
        try {
            ...
            if (result.usage) {
                span.setAttribute(SpanAttributes.GEN_AI_USAGE_TOTAL_TOKENS, (_a = result.usage) === null || _a === void 0 ? void 0 : _a.total_tokens);
                span.setAttribute(ATTR_GEN_AI_USAGE_OUTPUT_TOKENS, (_b = result.usage) === null || _b === void 0 ? void 0 : _b.completion_tokens);
                span.setAttribute(ATTR_GEN_AI_USAGE_INPUT_TOKENS, (_c = result.usage) === null || _c === void 0 ? void 0 : _c.prompt_tokens);
            }
            if (type === GEN_AI_OPERATION_NAME_VALUE_CHAT) {
    ...
    _endResponsesSpan(span, result) {
        ...
        try {
            ...
            if (result.usage) {
                ...
                const totalTokens = typeof result.usage.total_tokens === "number"
