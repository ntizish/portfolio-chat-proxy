...
import { ATTR_GEN_AI_REQUEST_MODEL, ATTR_GEN_AI_REQUEST_MAX_TOKENS, ATTR_GEN_AI_REQUEST_TEMPERATURE, ATTR_GEN_AI_REQUEST_TOP_P, ATTR_GEN_AI_PROMPT, ATTR_GEN_AI_RESPONSE_MODEL, ATTR_GEN_AI_USAGE_COMPLETION_TOKENS, ATTR_GEN_AI_USAGE_PROMPT_TOKENS, ATTR_GEN_AI_COMPLETION, ATTR_GEN_AI_SYSTEM } from '@opentelemetry/semantic-conventions/incubating';
    ...
    _endSpan({ span, type, result, }) {
        ...
        try {
            ...
            if (result.usage) {
                ...
                span.setAttribute(ATTR_GEN_AI_USAGE_COMPLETION_TOKENS, (_b = result.usage) === null || _b === void 0 ? void 0 : _b.completion_tokens);
                span.setAttribute(ATTR_GEN_AI_USAGE_PROMPT_TOKENS, (_c = result.usage) === null || _c === void 0 ? void 0 : _c.prompt_tokens);
            }
            if (this._shouldSendPrompts()) {
                if (type === "chat") {
                    result.choices.forEach((choice, index) => {
                        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s;
                        span.setAttribute(`${ATTR_GEN_AI_COMPLETION}.${index}.finish_reason`, (_a = choice.finish_reason) !== null && _a !== void 0 ? _a : "");
                        span.setAttribute(`${ATTR_GEN_AI_COMPLETION}.${index}.role`, (_c = (_b = choice.message) === null || _b === void 0 ? void 0 : _b.role) !== null && _c !== void 0 ? _c : "");
                        span.setAttribute(`${ATTR_GEN_AI_COMPLETION}.${index}.content`, (_e = (_d = choice.message) === null || _d === void 0 ? void 0 : _d.content) !== null && _e !== void 0 ? _e : "");
                        if ((_f = choice.message) === null || _f === void 0 ? void 0 : _f.function_call) {
                            span.setAttribute(`${ATTR_GEN_AI_COMPLETION}.${index}.function_call.name`, (_j = (_h = (_g = choice.message) === null || _g === void 0 ? void 0 : _g.function_call) === null || _h === void 0 ? void 0 : _h.name) !== null && _j !== void 0 ? _j : "");
                            span.setAttribute(`${ATTR_GEN_AI_COMPLETION}.${index}.function_call.arguments`, (_m = (_l = (_k = choice.message) === null || _k === void 0 ? void 0 : _k.function_call) === null || _l === void 0 ? void 0 : _l.arguments) !== null && _m !== void 0 ? _m : "");
                        }
                        else if ((_p = (_o = choice.message) === null || _o === void 0 ? void 0 : _o.tool_calls) === null || _p === void 0 ? void 0 : _p[0]) {
                            span.setAttribute(`${ATTR_GEN_AI_COMPLETION}.${index}.function_call.name`, (_q = choice.message.tool_calls[0].function.name) !== null && _q !== void 0 ? _q : "");
                            span.setAttribute(`${ATTR_GEN_AI_COMPLETION}.${index}.function_call.arguments`, (_r = choice.message.tool_calls[0].function.arguments) !== null && _r !== void 0 ? _r : "");
                        }
                        if ((_s = choice === null || choice === void 0 ? void 0 : choice.message) === null || _s === void 0 ? void 0 : _s.tool_calls) {
                            for (const [toolIndex, toolCall,] of choice.message.tool_calls.entries()) {
                                span.setAttribute(`${ATTR_GEN_AI_COMPLETION}.${index}.tool_calls.${toolIndex}.name`, toolCall.function.name);
                                span.setAttribute(`${ATTR_GEN_AI_COMPLETION}.${index}.tool_calls.${toolIndex}.arguments`, toolCall.function.arguments);
                            }
                        }
                    });
                }
                    ...
                    result.choices.forEach((choice, index) => {
                        ...
                        span.setAttribute(`${ATTR_GEN_AI_COMPLETION}.${index}.content`, (_b = choice.text) !== null && _b !== void 0 ? _b : "");
                    });
                }
            }
        }
